...
var buildFields = exports.buildFields = function buildFields(introspectionResults) {
    return function (fields) {
        return fields.reduce(function (acc, field) {
            ...
            if (linkedType) {
                return (0, _extends26.default)({}, acc, (0, _defineProperty3.default)({}, field.name, { fields: buildFields(introspectionResults)(linkedType.fields) }));
            }
...
var buildVariables = exports.buildVariables = function buildVariables(introspectionResults) {
    return function (resource, aorFetchType, params, queryType) {
        switch (aorFetchType) {
                    ...
                    var filter = Object.keys(params.filter).reduce(function (acc, key) {
                        ...
                        if (parts.length > 1) {
                            if (parts[1] == 'id') {
                                ...
                                if (_filterSome) {
                                    return (0, _extends26.default)({}, acc, (0, _defineProperty3.default)({}, parts[0] + '_some', { id: params.filter[key] }));
                                }
            ...
            case _constants.GET_MANY:
                return {
                    filter: { id_in: params.ids }
                };
            case _constants.GET_MANY_REFERENCE:
                {
...
exports.default = function (introspectionResults) {
    ...
    return function (aorFetchType, resourceName, params) {
        ...
        return { query: (0, _graphqlTag2.default)(_templateObject, query), variables: variables, parseResponse: parseResponse };
    };
};